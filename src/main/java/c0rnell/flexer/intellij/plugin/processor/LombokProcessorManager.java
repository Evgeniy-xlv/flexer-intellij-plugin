...
import c0rnell.flexer.intellij.plugin.processor.clazz.GenerateModelClassProcessor;
...
public final class LombokProcessorManager {
    ...
    public static Collection<Processor> getLombokProcessors() {
        return Arrays.asList(
                ApplicationManager.getApplication().getService(GenerateModelClassProcessor.class),
...
//                ApplicationManager.getApplication().getService(GenerateModelProcessor.class),
